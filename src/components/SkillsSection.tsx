  ...
  const categories: { title: string; skills: Skill[] }[] = [
    {
      ...
      skills: [
        ...
        { name: "TypeScript", level: 40, color: "bg-primary" },
        { name: "Custom CSS", level: 65, color: "bg-primary" },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Vite", level: 55, color: "bg-secondary" },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Radix UI", level: 50, color: "bg-accent" },
